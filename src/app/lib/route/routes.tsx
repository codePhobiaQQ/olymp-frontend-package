...
export const routes: {
    ...
    navIcon: (className) => (
      ...
      >
        <path
          ...
          strokeLinecap="round"
        />
        <path d="M15 18H9" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    ),
    element: <GeneraPage />,
  ...
  {
    path: '/personal-account/qualifying-stages',
    navIcon: (className) => (
      <svg
        viewBox="0 0 48 48"
        fill="none"
      ...
      >
        ...
        />
        <path fillRule="evenodd" clipRule="evenodd" d="M16 25H24V27H16V25Z" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
  ...
  {
    path: '/personal-account/qualifying-stages/:olymp_slug',
    element: <QualifyingTaskPage />,
    layoutVariant: 'personalAccount',
  },
  {
    path: '/personal-account/qualifying-stages-results',
    navIcon: (className) => (
      <svg
        className={cn(className, 'fill-none stroke-current')}
        viewBox="0 0 32 32"
  ...
  {
    path: '/personal-account/final-stages',
    navIcon: (className) => (
      <svg
        className={cn(className, 'fill-none stroke-current')}
        viewBox="0 0 24 24"
    ...
    element: <AvailableFinalsList />,
    layoutVariant: 'personalAccount',
  },
  {
    path: '/personal-account/final-stages/:olymp',
    element: <RegistrationFinalPage />,
    layoutVariant: 'personalAccount',
  },
  {
